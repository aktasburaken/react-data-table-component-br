...
```sh
npm install react-data-table-component-br-br
```

### yarn

```sh
yarn add react-data-table-component-br-br
```
...
```sh
npm install react-data-table-component-br styled-components
```

### yarn

```sh
yarn add react-data-table-component-br styled-components
```