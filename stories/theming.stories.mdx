...
Refer to [themes.ts](https://github.com/jbetancur/react-data-table-component-br/blob/master/src/DataTable/themes.ts) for properties you can use to create your own color theme.
