...
```js
import DataTable { Direction } from 'react-data-table-component-br';
...
```js
import DataTable { Alignment } from 'react-data-table-component-br';
...
```js
import DataTable { Media } from 'react-data-table-component-br';
